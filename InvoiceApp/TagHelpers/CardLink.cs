...
namespace InvoiceApp.TagHelpers
{
	...
	public class CardLink : TagHelper
	{
		...
		public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
		{
			...
			output.Attributes.Add("class", "card-link card rounded text-decoration-none d-inline-flex flex-column align-items-center justify-content-center gap-1 py-1 px-0 m-0");
